...
Vettore Vettore::operator^(const Vettore& b) const{ //non posso usare lo stesso simbolo del prodotto scalare in quanto differiscono per il valore di ritorno
  Vettore res;
  res.X(m_v[1]*b.m_v[2]-m_v[2]*b.m_v[1]); //il prodotto vettore è antisimmetrico
